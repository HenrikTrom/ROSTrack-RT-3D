...
echo "libgentl_*.deb"
echo 'yes' | sudo dpkg -i libgentl_*.deb

echo "libspinnaker_*.deb"
echo 'yes' | sudo dpkg -i libspinnaker_*.deb

echo "libspinnaker-dev_*.deb"
sudo dpkg -i libspinnaker-dev_*.deb

echo "libspinnaker-c_*.deb"
sudo dpkg -i libspinnaker-c_*.deb

echo "libspinnaker-c-dev_*.deb"
sudo dpkg -i libspinnaker-c-dev_*.deb

echo "libspinvideo_*.deb"
sudo dpkg -i libspinvideo_*.deb

echo "libspinvideo-dev_*.deb"
sudo dpkg -i libspinvideo-dev_*.deb

echo "libspinvideo-c_*.deb"
...
echo '\n n' | sudo sh configure_spinnaker.sh
# fi
